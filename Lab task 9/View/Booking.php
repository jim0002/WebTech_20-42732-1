	...
	<?php 
        ...
        <div style="border: 1px solid white; width: 24%; height: 430px;margin-top: 4px; color: white; font-size: 20px; float: left; background: #ABB2B9;" >
              ...
              <table>  
                          ...
                          foreach($booking->getUsers()  as $row)  
                          {  
                               echo '<tr>
                               <td>'.$row['Client_ID'].'</td>
                               <td>'.$row['Car_ID'].'</td>
                               ...
                               <td>'.$row['Time'].'</td>
                               <td>'.$row['Status'].'</td>
                               <td><a href="EditBooking.php?edit='.$row['Id'].'">Edit</a></td>
                               <td><a href="EditBooking.php?delete='.$row['Id'].'">Delete</a></td>
                               </tr>';  
        ...
        <a href="AddBooking.php" style="float:right; padding-right: 30px; padding-top: 20px">Add New</a>     
